...
from fitness_mean_dist import Fitness
...
def run():
    ...
    ###################################################################################################
    # TODO: set values
    experiment_id = "meandist_collision100"
    run_id = round(time.time())  # or some other num value
    gen_count = 2000
    step_count = 1000
    animate = False
    map_path = 'C:/_user/_other/diplo/code/navigation-neuro-evolution-develop/maps/map_73_path_2_flip.png'
    ###################################################################################################
    ###################################################################################################
    ###################################################################################################
    ...
    copy2('meandist_collision100/neat_config', config_path)
    ...
    if map_path is None:
        ...
        sim_map = MapFactory.create_from_pic(map_path, [23, 23], [220, 30])
    ###################################################################################################

    ###################################################################################################
    # Initialize robot
    robot = Robot(radius=5,
