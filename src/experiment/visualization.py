...
def get_image(robot_bodies, sensor_lines, map):
    ...
    # start point as blue
    local_map[map.start_point[0, 0, 0], map.start_point[0, 0, 1], 0] = 0
    local_map[map.start_point[0, 0, 0], map.start_point[0, 0, 1], 1] = 0
    local_map[map.start_point[0, 0, 0], map.start_point[0, 0, 1], 2] = 255

    # end point as green
    local_map[map.end_point[0, 0, 0], map.end_point[0, 0, 1], 0] = 0
    local_map[map.end_point[0, 0, 0], map.end_point[0, 0, 1], 1] = 255
    local_map[map.end_point[0, 0, 0], map.end_point[0, 0, 1], 2] = 0
