...
from fitness_collision_aiming import Fitness
...
copy2('to_target/neat_config', config_path)
...
GenomeVisualizer.draw_net(neat_conf, winner, False, filename=winner_file)
